...
/**
 * Describe how you could use a single array to implement three stacks.<br/>
 * 
 * @author bbadarch
 *
 */
...
class MultiStackSolution2 {
	public static void printStacks(MultiStackSolution2 stacks) {
	...
	public static void main(String[] args) throws Exception {
		MultiStackSolution2 stacks = new MultiStackSolution2(3, 4);
		printStacks(stacks);
		stacks.push(0, 10);
		printStacks(stacks);
		stacks.push(1, 20);
	...
	public MultiStackSolution2(int numberOfStacks, int defaultSize) {
